...
class SQLiteLedger:
    ...
    def __init__(self, path: Path) -> None:
        ...
        self.path = path
        # One connection shared by the threadpool. sqlite3 does not serialise a
        # connection used from several threads, so interleaved execute/commit
        # calls returned another request's rows or raised. Every call takes the lock.
